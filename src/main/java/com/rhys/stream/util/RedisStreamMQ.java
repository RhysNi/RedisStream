...
public class RedisStreamMQ {
    ...
    public StreamEntryID produce(String key, Map<String, String> message) {
        ...
        try {
            ...
            System.out.println("发布消息到" + key + " 返回消息id=" + id.toString());
            return id;
        } catch (Exception e) {
    ...
    public void createCustomGroup(String key, String groupName, String lastDeliveredId) {
        ...
        try {
            ...
            jedis.xgroupCreate(key, groupName, id, false);
     ...
     * @param customerName
     * @param groupName
     * @return java.util.List<java.util.Map.Entry < java.lang.String, java.util.List < redis.clients.jedis.resps.StreamEntry>>>
     * @author Rhys.Ni
     * @date 2022/5/26
     */
    public List<Map.Entry<String, List<StreamEntry>>> consume(String key, String customerName, String groupName) {
        ...
        try {
            ...
            System.out.println(groupName + "从" + key + "接受消息, 返回消息：" + result);
            return result;
        } catch (Exception e) {
    ...
    public void ackMsg(String key, String groupName, StreamEntryID msgId) {
        ...
        try {
            ...
            System.out.println(key + "，消费群组" + groupName + " 消息已确认");
        } catch (Exception e) {
    ...
    public boolean checkGroup(String key, String groupName) {
        ...
        try {
            jedis = jedisPool.getResource();
            var xinfoGroupResult = jedis.xinfoGroup(key);
    ...
    public void MqInfo(int type, String key, String groupName) {
        ...
        try {
            ...
            if (type == MQ_INFO_CONSUMER) {
                List<StreamConsumersInfo> xinfoConsumersResult = jedis.xinfoConsumers(key, groupName);
                System.out.println(key + " 消费者信息:" + xinfoConsumersResult);
                ...
                List<StreamGroupInfo> xinfoGroupResult = jedis.xinfoGroup(key);
                System.out.println(key + "消费者群组信息:" + xinfoGroupResult);
                for (StreamGroupInfo groupinfo : xinfoGroupResult) {
                ...
                StreamInfo xinfoStreamResult = jedis.xinfoStream(key);
                System.out.println(key + "队列信息:" + xinfoStreamResult);
